...
import { CpuChipIcon, ArrowRightIcon } from '@heroicons/react/24/solid'
                ...
                <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        ...
                        <div className='bg-slate-100 pl-8 py-4'>
                            <p className='flex items-center text-orange-600'>Contact Us <ArrowRightIcon className='w-5 ml-2' /></p>
                        </div>
                    </div>
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <ChatBubbleLeftRightIcon className='w-16 p-4 bg-orange-600 text-white rounded-lg mt-[-4rem]' />
                    ...
                    <div className='bg-white rounded-xl shadow-2xl'>
                        <div className='p-8'>
                            <CpuChipIcon className='w-16 p-4 bg-orange-600 text-white rounded-lg mt-[-4rem]' />
